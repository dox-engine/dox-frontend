function DisclaimerDox() {
    return (
        <div className="-mx-4 no-scrollbar max-h-[50vh] overflow-y-auto px-4 typeset  typeset-article">
            <h1>
                Disclaimer
            </h1>
            <p>
            ...
            <ul>
                <li>
                    <p>
                        ...
                        {" "}
                        (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Disclaimer) refers to Dox Engine.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        ...
                        {" "}
                        refers to Dox Engine, accessible from
                        {" "} 
                        <a href="dox-engine.ir" rel="external nofollow noopener" target="_blank">
                            dox-engine.ir
                        </a>.
                    </p>
                </li>
            ...
            <ul>
                <li>
                    <p>
                        By email: info@dox-engine.ir
                    </p>
                </li>
                <li>
                    <p>
                        By visiting this page on our website:
                        <a href="https://dox-engine.ir/about" rel="external nofollow noopener" target="_blank">
                            https://dox-engine.ir/about
                        </a>
                    </p>
                </li>
            </ul>
