...
import PapersFilterTypes from "@/src/pages/papers/components/filters/types";
import PapersFilterCategories from "@/src/pages/papers/components/filters/categories";
import PapersFilterOrder from "@/src/pages/papers/components/filters/order";
